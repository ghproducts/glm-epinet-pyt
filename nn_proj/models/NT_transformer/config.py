...
"""
General configuration dataclasses for NT training.
"""

@dataclass
class ModelArguments:
    model_name_or_path: str = field(default="InstaDeepAI/nucleotide-transformer-v2-500m-multi-species")
    checkpoint: Optional[str] = field(default=None, metadata={"help": "Path to base model checkpoint."})
    epinet_path: Optional[str] = field(default=None, metadata={"help": "Path to epinet weights."})
