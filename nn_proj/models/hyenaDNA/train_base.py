...
from nn_proj.common.utils import preprocess_logits_for_metrics, compute_metrics, enable_mc_dropout
...
def safe_save_model_for_hf_trainer(trainer: transformers.Trainer, output_dir: str):
    """Save model + tokenizer without safetensors (avoids shared-tensor issue)."""
...
def train():
    ...
    model = enable_mc_dropout(model, p=0.1) # adjust p as needed
